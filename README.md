...
Private repository. Current baseline includes provider-free Feiyue core foundations through M9 and the M10 safe provider/profile integration foundation. Real provider smoke and Hermes profile execution remain gated on explicit authorization and configured credentials.
