...
- New targeted contracts cover review UI disabled actions, CLI reference generation, provider-free semantic review evidence, creative acceptance/taste metrics, and Wave10-1 through Wave13-1 execution-batch status sync.
